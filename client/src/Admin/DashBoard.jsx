          ...
          show?.schedules?.map((schedule, sIndex) => (
            ...
            >
              ...
              <img
                ...
                src={show?.movieId?.poster_path || '/images/default_poster.jpg'}
              />
              ...
              <div className="flex items-center justify-between px-2">
                ...
                <p className="flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1">
                  ...
                  {show?.movieId?.vote_average?.toFixed(1) || 'N/A'}
                </p>
              </div>
              ...
              <button
                ...
                onClick={() =>
                  handleDeleteShowInstance(admin.theater._id, show.movieId._id, sIndex)
                }
              >
