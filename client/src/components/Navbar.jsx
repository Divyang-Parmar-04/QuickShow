...
function Navbar() {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      <Link to='/' className='max-md:flex-1'><img src='/assets/logo.svg' alt="" className='w-35 h-auto' /></Link>
      ...
      <div className='flex items-center gap-8'>
        ...
        {!user ? (
          <button className='px-4 py-1 sm:px-7 sm:py-3 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer' onClick={openSignIn}>Login</button>
        ) : (
          <UserButton>
